...
import threading
stopuser = {}
token = '6845851088:AAEPM0risB41wCbokYUXz7NpIXkKFVtJugg'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/insta_troeej")
			keyboard.add(contact_button)
			random_number = random.randint(33, 82)
			photo_url = f'https://t.me/insta_troeej/{random_number}'
...
𝒀𝑶𝑼𝑹 𝑷𝑳𝑨𝑵 𝑵𝑶𝑾 {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗝𝗢𝗜𝗡 ✨", url="https://t.me/insta_troeej")
		keyboard.add(contact_button)
...
𝘽𝙤𝙩 𝘽𝙮 @JJ6JJQ''', reply_markup=mes)
